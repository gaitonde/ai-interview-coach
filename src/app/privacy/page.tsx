...
## Privacy Policy for InterviewCoach
Effective Date: November 19, 2024

**Introduction**
At InterviewCoach, we value your privacy and are committed to safeguarding the personal information you provide when using our website and services. This Privacy Policy outlines the types of information we collect, how we use it, and the measures we take to protect it. By using InterviewCoach’s services, you agree to the terms outlined in this policy.

### 1. Information We Collect
To provide our personalized interview preparation services, we collect the following types of information:
* **Personal Data:** When you sign up for InterviewCoach, you may be asked to provide personal details, such as your name, email address, and job-related information. This may include your resume, job descriptions, and specific data related to the interview process (e.g., answers to mock interview questions).
...
* **Access Control:** Only authorized personnel within InterviewCoach have access to your personal data, and we limit this access to those who need it to provide services.
...
InterviewCoach uses cookies and similar tracking technologies to enhance your user experience. Cookies are small files stored on your device that help us remember your preferences and improve our services. You can manage your cookie preferences through your browser settings, including the option to disable cookies. However, disabling cookies may affect your experience with our site.
...
By using InterviewCoach, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.
`} />
    </div>
  );
}
